...
<p align="center">
  <img src="https://img.shields.io/badge/version-v0.5.1-C45E2A?style=flat-square" alt="v0.5.1" />
...
Canonical package names for `v0.5.1` are `carapace-sdk` on npm and
...
| v0.5.1 | ✅ Current | Receipt integrity and expiry corrective release; see [migration guide](docs/RECEIPTS_V2.md) |
| v0.5.0 | Previous | Active trust-control alignment and registry-facing verification updates |
